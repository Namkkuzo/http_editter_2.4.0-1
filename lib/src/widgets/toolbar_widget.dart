                                    ...
                                    Row(
                                      children: <Widget>[
                                        ...
                                        ElevatedButton(
                                          ...
                                          child: Text('Mở trong cửa sổ mới',
                                              style: TextStyle(
                                                  color: Theme.of(context)
                                                      .textTheme
                                                      .bodyText1
                              ...
                              TextButton(
                                onPressed: () async {
                                  if (filename.text.isEmpty &&
                                    ...
                                    setState(() {
                                      validateFailed =
                                          'Vui lòng chọn 1 ảnh hoặc nhập 1 đường dẫn!';
                                    });
                                  } else if (filename.text.isNotEmpty &&
                                      url.text.isNotEmpty) {
                                    setState(() {
                                      validateFailed =
                                          'Vui lòng chỉ nhập đường dẫn hoặc chọn ảnh!';
                                    });
                                  } else if (filename.text.isNotEmpty &&
                              ...
                              TextButton(
                                onPressed: () async {
                                  if (filename.text.isEmpty &&
                                    ...
                                    setState(() {
                                      validateFailed =
                                          'Vui lòng chọn 1 video hoặc nhập 1 đường dẫn!';
                                    });
                                  } else if (filename.text.isNotEmpty &&
                                      url.text.isNotEmpty) {
                                    setState(() {
                                      validateFailed =
                                          'Vui lòng chỉ chọn đường dẫn hoặc video!';
                                    });
                                  } else if (filename.text.isNotEmpty &&
                                      result?.files.single.bytes != null) {
                                    var base64Data = base64
                              ...
                              TextButton(
                                onPressed: () {
                                  if (filename.text.isEmpty &&
                                    ...
                                    setState(() {
                                      validateFailed =
                                          'Vui lòng chọn tệp hoặc nhập đường dẫn!';
                                    });
                                  } else if (filename.text.isNotEmpty &&
                                      url.text.isNotEmpty) {
                                    setState(() {
                                      validateFailed =
                                          'Vui lòng chỉ nhập đường dẫn hoặc tệp!';
                                    });
                                  } else if (filename.text.isNotEmpty &&
                                      result?.files.single.bytes != null) {
